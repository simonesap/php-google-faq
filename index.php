        ...
        <div class="container-default">
            <div id="questionAnswer">
                ...
                <?php foreach($faqs as $faq) { ?>
                        ...
                        <h2 class="m_t_10"> <?php echo $faq['question']; ?> </h2>

                        <p class="m_t_10 m_b_70"> <?php echo $faq['answer']; ?> </p>
