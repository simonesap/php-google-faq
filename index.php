    ...
    <header class="flexBetween container-default-2">
        ...
        <div>
            <div style="height: 50px;">
                <img style="width: 70px; height: 40px;" src="./assets/img/logo-google.png" alt="google">
                <span class="vertical_bottom">Privacy e termini</span>
            </div>
            <div>
                <ul class="reset-list flexRow">
                    ...
                    <li class="m_e_20">
                        <a class="reset-decoration text_black" href="#">Norme sulla privacy</a>
                    </li>
                    <li class="m_e_20">
                        <a class="reset-decoration text_black" href="#">Termini di servizio</a> 
                    </li>
                    <li class="m_e_20">
                        <a class="reset-decoration text_black" href="#">Tecnologie</a> 
                    </li>
                    <li class="m_e_20">
                        <a class="reset-decoration text_black" href="#">Domande frequenti</a> 
                    </li>
                </ul>
            </div>
        </div>
